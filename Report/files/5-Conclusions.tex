...
\begin{itemize}
    \item \textbf{RGB Logic}: Utilize the integrated hardware RGB LED to provide immediate physical feedback from the network status, such as connection quality or alarm triggers.
    
    \item \textbf{Telegram Bot Integration}: Develop an automated Telegram bot via the REST API to allow farmers to modify device attributes, set telemetry ranges, and request real-time sensor snapshots directly from their mobile devices.
