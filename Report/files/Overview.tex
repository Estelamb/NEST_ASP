...
\begin{itemize}
    ...
    \item \textbf{Remote Sync}: This attribute update is received by the ESP32's \texttt{mqttCallback}, which immediately triggers the servos to close the \gls{NEST} door, protecting the production until a person identifies themselves to collect it.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/rule_workflow_1.png}
    \caption{ThingsBoard Workflow Sequence Diagram (1)}
    \label{fig:tb_workflow}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/rule_workflow_2.png}
    \caption{ThingsBoard Workflow Sequence Diagram (2)}
    \label{fig:tb_workflow_2}
\end{figure}
