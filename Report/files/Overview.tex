...
\end{itemize}
\todo{add init y alarms}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/nest_workflow.png}
    \caption{\acrshort{NEST} Device Workflow Sequence Diagram}
    \label{fig:nest_workflow}
\end{figure}
\todo{rule chain}
%\todo{hacer workflow thingsboard}
%
%\begin{figure}[H]
%    \centering
%    %\includegraphics[width=1\textwidth]{images/tb_workflow.png}
