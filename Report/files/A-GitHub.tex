\section{- GitHub}\todo{rewrite}

\subsection{GitHub Repository - Source Code}

The complete source code of the Plant Monitoring System project is hosted on GitHub and can be accessed via the following link: \url{https://github.com/Estelamb/NEST_ASP}.

\subsection{GitHub Pages - Documentation}

The project documentation can be accessed through the following link: \url{https://estelamb.github.io/NEST_ASP/}.
