...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/server_attributes.png} 
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.9\textwidth]{images/client_attributes.png} 
